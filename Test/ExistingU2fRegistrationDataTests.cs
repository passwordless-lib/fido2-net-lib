...
namespace fido2_net_lib.Test
{
    public class ExistingU2fRegistrationDataTests
    {
        ...
        public async Task TestFido2AssertionWithExistingU2fRegistrationWithAppId()
        {
            ...
            //key as cbor
            var publicKey = CreateFromU2fRegistrationData(keyHandleData, publicKeyData);
            ...
            var fido2 = new Fido2(new Fido2.Configuration
            {
        ...
        public static CBORObject CreateFromU2fRegistrationData(byte[] keyHandleData, byte[] publicKeyData)
        {
            var publicKey = new ECDsaCng(ConvertPublicKey(publicKeyData));

            var coseKey = CBORObject.NewMap();

            var kty = COSE.KeyType.EC2;
