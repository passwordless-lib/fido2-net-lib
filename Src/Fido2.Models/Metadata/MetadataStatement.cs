...
namespace Fido2NetLib
{
    ...
    public class MetadataStatement
    {
        ...
        /// </summary>
        [JsonPropertyName("publicKeyAlgAndEncoding")]
        ...
        /// </summary>
        [JsonPropertyName("isSecondFactorOnly")]
