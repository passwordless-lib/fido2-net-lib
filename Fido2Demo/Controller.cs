...
namespace Fido2Demo
{
    ...
    public class MyController : Controller
    {
        ...
        private static readonly ActiveDirectoryStore adStore = new ActiveDirectoryStore();
        ...
        {
            // 1. Get user from DB
            var user = adStore.GetUser(username + "@example.com");

            // 2. Get registered credentials from database
            var existingCredentials = adStore.GetCredentialsByUser(user);
