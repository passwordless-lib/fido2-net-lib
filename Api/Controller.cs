...
public class MyController : Controller
{
    ...
    public MyController(IFido2 fido2, IConfiguration configuration, IHostEnvironment env)
    {
        _fido2 = fido2;
    ...
    {
        return string.Format($"{e.Message}{(e.InnerException == null ? "" : " (" + e.InnerException.Message + ")")}");
    }
